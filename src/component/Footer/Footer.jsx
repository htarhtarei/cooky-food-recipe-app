...
const Footer = () => {
  return (
    <div className=" bg-slate-950 py-12 w-full text-white grid md:grid-cols-2 lg:grid-cols-4 px-4 md:px-18 lg:px-20">
      <div className="pb-8">
      ...
      <div className="pb-8">
        <h1 className=" pb-3 text-xl font-bold">About Cooky</h1>
        <ul>
          <li className="pb-2 text-gray-400">
